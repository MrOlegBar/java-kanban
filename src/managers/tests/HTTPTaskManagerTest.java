...
class HTTPTaskManagerTest extends TaskManagerTest {
    ...
    void fromJson() throws IOException, InterruptedException {
        ...
        assertEquals(manager.getTaskById(task1.getId()), managerActual.getTaskById(task1.getId())
                , "Задача " + task1 + " восстановилась не правильно");
        assertEquals(manager.getTaskById(task2.getId()), managerActual.getTaskById(task2.getId())
                , "Задача " + task2 + " восстановилась не правильно");
        assertEquals(manager.getEpicTaskById(epicTask1.getId()), managerActual.getEpicTaskById(epicTask1.getId())
                , "Задача " + epicTask1 + " восстановилась не правильно");
        assertEquals(manager.getEpicTaskById(epicTask2.getId()), managerActual.getEpicTaskById(epicTask2.getId())
                , "Задача " + epicTask2 + " восстановилась не правильно");
        assertEquals(manager.getSubTaskById(subTask1.getId()), managerActual.getSubTaskById(subTask1.getId())
                , "Задача " + subTask1 + " восстановилась не правильно");
        assertEquals(manager.getSubTaskById(subTask2.getId()), managerActual.getSubTaskById(subTask2.getId())
                , "Задача " + subTask2 + " восстановилась не правильно");
        assertEquals(manager.getSubTaskById(subTask3.getId()), managerActual.getSubTaskById(subTask3.getId())

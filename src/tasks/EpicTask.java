...
public class EpicTask extends Task {
    ...
    public boolean equals(Object o) {
        ...
        return getId() == epicTask.getId() && getDuration() == epicTask.getDuration()
                && getName().equals(epicTask.getName())
                && getDescription().equals(epicTask.getDescription()) && getStatus() == epicTask.getStatus()
                && Objects.equals(getStartTime(), epicTask.getStartTime())
                && Objects.equals(getEndTime(), epicTask.getEndTime())
